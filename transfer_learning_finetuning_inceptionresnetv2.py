...
def train_model(opt):
        ...
        best_model_wts = copy.deepcopy(my_inceptionresnetv2.state_dict())
        best_acc = 0.
           ...
           # legend = ['train'+'epoch_loss','train'+'epoch_acc','val'+'epoch_loss','val'+'epoch_acc']
            ...
            for phase in mode:
                ...
                if phase == 'train':
                    ...
                    my_inceptionresnetv2.train()
                else :
                    my_inceptionresnetv2.eval()
                ...
                for inputs, labels in data_loaders[phase]:
                    ...
                    with torch.set_grad_enabled(phase == 'train'):
                        ...
                        outputs = my_inceptionresnetv2(inputs)
                        # if phase =='train':
                        #     outputs = my_inceptionresnetv2(inputs)[0]
            ...
            if epoch % opt.save_epoch_freq==0:
                save_net_works(opt,epoch,my_inceptionresnetv2)
        my_inceptionresnetv2.load_state_dict(best_model_wts)
...
if __name__ =='__main__':
    ...
    my_inceptionresnetv2 = make_model('inceptionresnetv2',num_classes=4,pretrained=True,pool=nn.AdaptiveMaxPool2d(1))
    #my_inceptionresnetv2 = pretrainedmodels.inceptionresnetv2(1000,pretrained='imagenet')
    #my_inceptionresnetv2 = torchvision.models.inceptionresnetv2(pretrained=True)

    # dim_feats = my_inceptionresnetv2.last_linear # =2048
    # nb_classes = 4
    # my_inceptionresnetv2.last_linear = nn.Linear(66560, nb_classes)

    my_inceptionresnetv2 = nn.DataParallel(my_inceptionresnetv2).cuda()
    my_inceptionresnetv2 = my_inceptionresnetv2.to(device)



    criterion = nn.CrossEntropyLoss()

    optimizer = optim.SGD(my_inceptionresnetv2.parameters(), lr=opt.lr, momentum=0.9,weight_decay=5e-4)

    #exp_lr_scheduler = lr_scheduler.StepLR(optimizer, step_size=7, gamma=0.1)

    print(my_inceptionresnetv2)
